...
namespace MvcOpenID.Razor.Basic.Models
{
    public class UserRepository
    {
        ...
        {
            userDb.Users.Remove(user); //EFCodeFirst
        }
        ...
        public void AddOpenId(OpenId openid)
        {
            ...
            userDb.OpenIds.Add(openid); //EFCodeFirst
        }
        ...
        public void RemoveOpenId(string identifier)
        {
            ...
            {
                userDb.OpenIds.Remove(openid); //EFCodeFirst
            }
            else
