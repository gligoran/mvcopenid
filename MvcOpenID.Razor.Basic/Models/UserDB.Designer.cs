...
[assembly: EdmRelationshipAttribute("MvcOpenID.Models.UserDB", "FK_UserOpenId", "Users", System.Data.Metadata.Edm.RelationshipMultiplicity.One, typeof(MvcOpenID.Razor.Basic.Models.User), "OpenIds", System.Data.Metadata.Edm.RelationshipMultiplicity.Many, typeof(MvcOpenID.Razor.Basic.Models.OpenId), true)]
...
namespace MvcOpenID.Razor.Basic.Models
{
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="MvcOpenID.Models.UserDB", Name="OpenId")]
    [Serializable()]
    ...
    public partial class OpenId : EntityObject
    {
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("MvcOpenID.Models.UserDB", "FK_UserOpenId", "Users")]
        public User User
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<User>("MvcOpenID.Models.UserDB.FK_UserOpenId", "Users").Value;
            }
            set
            {
                ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<User>("MvcOpenID.Models.UserDB.FK_UserOpenId", "Users").Value = value;
            }
        }
        /// <summary>
        /// No Metadata Documentation available.
        ...
        public EntityReference<User> UserReference
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedReference<User>("MvcOpenID.Models.UserDB.FK_UserOpenId", "Users");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedReference<User>("MvcOpenID.Models.UserDB.FK_UserOpenId", "Users", value);
                }
            }
        }
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="MvcOpenID.Models.UserDB", Name="User")]
    [Serializable()]
    [DataContractAttribute(IsReference=true)]
    public partial class User : EntityObject
    {
        ...
        [SoapIgnoreAttribute()]
        [DataMemberAttribute()]
        [EdmRelationshipNavigationPropertyAttribute("MvcOpenID.Models.UserDB", "FK_UserOpenId", "OpenIds")]
        public EntityCollection<OpenId> OpenIds
        {
            get
            {
                return ((IEntityWithRelationships)this).RelationshipManager.GetRelatedCollection<OpenId>("MvcOpenID.Models.UserDB.FK_UserOpenId", "OpenIds");
            }
            set
            {
                if ((value != null))
                {
                    ((IEntityWithRelationships)this).RelationshipManager.InitializeRelatedCollection<OpenId>("MvcOpenID.Models.UserDB.FK_UserOpenId", "OpenIds", value);
                }
            }
        }
